...
public class ApiClient {
    ...
    private String basePath = "http://localhost:8080/tfg-sigase-api";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://localhost:8080/tfg-sigase-api",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost:8080/tfg-sigase-api
