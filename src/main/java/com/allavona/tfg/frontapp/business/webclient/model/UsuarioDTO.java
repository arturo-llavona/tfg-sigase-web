...
public class UsuarioDTO {
  ...
  public UsuarioDTO idUsuario(Integer idUsuario) {
  ...
  **/
  ...
  public UsuarioDTO extension(String extension) {
  ...
  **/
  ...
  public UsuarioDTO tipoUsuario(Integer tipoUsuario) {
  ...
  **/
  ...
  public UsuarioDTO habilitado(Boolean habilitado) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.idUsuario, usuarioDTO.idUsuario) &&
        Objects.equals(this.nombre, usuarioDTO.nombre) &&
        Objects.equals(this.apellido1, usuarioDTO.apellido1) &&
        Objects.equals(this.apellido2, usuarioDTO.apellido2) &&
        Objects.equals(this.email, usuarioDTO.email) &&
        Objects.equals(this.extension, usuarioDTO.extension) &&
        Objects.equals(this.tipoUsuario, usuarioDTO.tipoUsuario) &&
        Objects.equals(this.username, usuarioDTO.username) &&
        Objects.equals(this.password, usuarioDTO.password) &&
        Objects.equals(this.habilitado, usuarioDTO.habilitado);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UsuarioDTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UsuarioDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UsuarioDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UsuarioDTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
